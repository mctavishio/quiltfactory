module.exports = (() => {
	...
	const pigmenttypes = { 
		...
		bluegreen: pigmentdefs.filter(p=>p[0]==="bluegreen"),
	...
	*/
	...
	let wgraycore = [3,2,2,2];
	let wcolorcore = [2,3,4,2];
		...
		pigmentsets: [
			{
				color1: { color: pigments.darkgray, name: "darkgray", weights: wdarkcore, },
				color2: { color: pigments.white, name: "white", weights: wlightcore, },
				color3: { color: pigments.red, name: "red", weights: wcolorcore, },
			},
			{
			...
			},
			{
				color1: { color: pigments.darkgray, name: "darkgray", weights: wdarkcore, },
				color2: { color: pigments.white, name: "white", weights: wlightcore, },
				color3: { color: pigments.orange, name: "orange", weights: wcolorcore, },
			},
			{
				color1: { color: pigments.gray, name: "gray", weights: wdarkcore, },
				color2: { color: pigments.white, name: "white", weights: wlightcore, },
				color3: { color: pigments.yellow, name: "yellow", weights: wcolorcore, },
			},
			{
				color1: { color: pigments.darkgray, name: "darkgray", weights: wdarkcore, },
				color2: { color: pigments.white, name: "white", weights: wlightcore, },
				color3: { color: pigments.blue, name: "blue", weights: [2,2,4,2], },
			},
			{
				color1: { color: pigments.darkgray, name: "darkgray", weights: wdarkcore, },
				color2: { color: pigments.white, name: "white", weights: wlightcore, },
				color3: { color: pigments.blue3, name: "blue3", weights: wcolorcore, },
			},
			{
				color1: { color: pigments.darkgray, name: "darkgray", weights: wdarkcore, },
				color2: { color: pigments.white, name: "white", weights: wlightcore, },
				color3: { color: pigments.blue2, name: "blue2", weights: wcolorcore, },
			},
			{
				color1: { color: pigments.blue, name: "blue", weights: wdarkcore, },
				color2: { color: pigments.white, name: "white", weights: wlightcore, },
				color3: { color: pigments.bluegreen, name: "bluegreen", weights: wcolorcore, },
			},
		]
	}
})();
