...
console.log(`blocks[0][1][2]=${blocks[0][1][2]}`);
console.log(`blocks[1][1][2]=${blocks[1][1][2]}`);
console.log(`blocks[2][1][2]=${blocks[2][1][2]}`);
...
//		console.log(`dy=${dx}`);
		...
		[0,1,2,3].forEach( r => {
			[0,1,2,3].forEach( c => {
				let color = blocks[nframe%blocks.length][r][c]; 
				++bcount;
				// console.log(`r=${r}, c=${c}`);
