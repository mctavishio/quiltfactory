...
module.exports = (() => {
	...
	let wdarkcore = [8,1,2,2];
	let wlightcore = [1,11,0,1];
	let wgraycore = [0,0,0,0];
	let wcolorcore = [1,1,1,1];
	...
	let pigmentsets = [
			...
			{
				color1: { color: pigments.darkgray, name: "darkgray", weights: [4,0,1,1], },
				color2: { color: pigments.lightgray, name: "lightgray", weights: wlightcore, },
				color3: { color: pigments.gray, name: "gray", weights: wgraycore, },
				color4: { color: pigments.red, name: "red", weights: wcolorcore, },
			},
			{
			...
			{
				color1: { color: pigments.darkgray, name: "gray", weights: wdarkcore, },
				color2: { color: pigments.white, name: "white", weights: wlightcore, },
				color3: { color: pigments.gray, name: "blue", weights: wgraycore, },
				color4: { color: pigments.bluegreen, name: "bluegreen", weights: wcolorcore, },
			},
			{
				color1: { color: pigments.darkgray, name: "gray", weights: wdarkcore, },
				color2: { color: pigments.white, name: "white", weights: wlightcore, },
				color3: { color: pigments.blue, name: "blue", weights: wgraycore, },
				color4: { color: pigments.blue2, name: "blue2", weights: wcolorcore, },
			},
			{
